...
class sb_bar_Social {
	...
	public function get_shares_facebook($post_id) {
		...
		if( !is_wp_error( $response ) ) {
			...
			// Notice: Undefined index: shares in /home/itsgoran/public_html/wp/wp-content/plugins/dougr-bar/includes/class-sb-bar-social.php on line 106
		} else {
			return 0;
		}
